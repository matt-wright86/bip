...
- **Terrence**: Before tech, he worked hospitality/retail with odd hours. He'd write during quiet windows—noon before a 2 PM shift, or late at night after kids were asleep. He's been working on daily journaling with Claudio's help, blocking time on his calendar and setting phone reminders. The social pressure of BiP has been a motivator: "People are always asking me what I'm working on. The more I say nothing, the more anxiety I feel. So I started doing things."

- **Claudio**: Shared his voice journaling process—phone on the dashboard during his 17-mile commute, hit record, just talk. Then transcribe later using the iPhone's built-in recorder, paste into ChatGPT, and extract insights or draft a blog post. Referenced Claudio's approach of never facing a blank page—he uses Obsidian to pepper notes throughout the day, so when he sits down to create, he's drawing from existing material, not starting from zero. Claudio recommended _The Artist's Way_ and its two practices: daily journaling (getting ideas out imperfectly) and blocking 2 hours a week for creative "playtime." He's also been tracking creation time vs. consumption time for the past year and a half to ensure he's creating more than consuming.
...
- **Matthew**: Found a workflow through Obsidian with a quick keyboard shortcut (via Alfred) that lets him drop a note into his daily Obsidian file instantly. Helps capture ideas without the friction of voice recording, which he also doesn't prefer.
